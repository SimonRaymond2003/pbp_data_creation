...
# Modified function to get team injury counts for past year and past week
get_team_injury_counts <- function(team, game_date) {
  ...
  year_injuries <- injuries_data %>%
    filter(team == team,
           injury_date >= year_ago,
  ...
  # Past week injuries by type
  week_ago <- game_date - 7
  week_injuries <- injuries_data %>%
    filter(team == team,
...
injury_count_year_Knee_offense   # Count of knee injuries for offense in past 365 days
injury_count_week_Knee_offense   # Count of knee injuries for offense in past 7 days
injury_count_year_Knee_defense   # Count of knee injuries for defense in past 365 days
injury_count_week_Knee_defense   # Count of knee injuries for defense in past 7 days